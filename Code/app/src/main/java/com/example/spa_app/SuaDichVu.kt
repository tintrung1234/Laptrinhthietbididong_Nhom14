...
@Composable
fun SuaDichVu(navController: NavController) {
    Column(
                    ...
                    Row(
                        ...
                        Text(
                            ...
                            modifier = Modifier.padding(8.dp)
                                .clickable(onClick = {navController.navigate("Thêm dịch vụ")})
                        )
                        Text(
                            "Sửa",
                            fontSize = 24.sp,
                        ...
                        BasicTextField(
                            ...
                            decorationBox = { innerTextField ->
                                if (text.value.isEmpty()) {
                                    Text("• Thư giãn toàn thân – Giảm căng thẳng, mệt mỏi.\u2028• Bấm huyệt – Cải thiện tuần hoàn, giảm đau nhức.\u2028• Phục hồi năng lượng – Tăng cường sức khỏe, ngủ ngon hơn.", color = Color.Gray)
                                }
                                innerTextField()
                            },
                            modifier = Modifier.fillMaxWidth()
